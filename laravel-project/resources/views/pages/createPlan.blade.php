...
@section('content')
    ...
    <body>
                ...
                <div class="card" id="card">
                    ...
                    <div class="card-body">
                        <input class="view_title form-control" type="text" size="30" id="view_title_s"
                            value="" placeholder="タイトル（集合　お昼ご飯）">
                    </div>
                    <div class="card-body">
                        <textarea class="view_body form-control" id="view_body_s" cols="30" rows="3" placeholder="◯◯駅集合！　◯◯でランチ！"></textarea>
                    </div>
                    <img class="remove" src="/images/delete-bin-fill.svg" alt="" onClick="remove_card()">
                </div>
        ...
        <button class="btn btn-primary" href="/index/create">作成</button>
        </div>
    </body>
@endsection
